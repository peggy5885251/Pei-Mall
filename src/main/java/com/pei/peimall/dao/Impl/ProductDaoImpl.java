...
public class ProductDaoImpl implements ProductDao {
    ...
    public Integer createProduct(ProductRequest productRequest) {
        String sql = "INSERT INTO product (product_name, category, image_url, " +
                ...
                " :createdDate, :lastModifiedDate, :onShelf, :offShelf) ";
        Map<String, Object> map = new HashMap<>();
        ...
        map.put("onShelf", productRequest.getOnShelf());
        map.put("offShelf", productRequest.getOffShelf());
    ...
    public void updateProduct(Integer productId, ProductRequest productRequest) {
        String sql = " UPDATE product SET product_name = :productName, category = :category, " +
                ...
                " last_modified_date = :lastModifiedDate, on_shelf = :onShelf, off_shelf = :offShelf " +
